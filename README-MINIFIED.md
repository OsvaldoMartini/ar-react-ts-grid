...
## RECOMENDATION  NO TUSE OBFUSCATOR
### Minify all 4 scripts with esbuild (one command each):

```bash
npx esbuild script-search-in-use.js --bundle --minify --outfile=script-search-in-use.min.js

npx esbuild script-hover-pick-in-use.js --bundle --minify --outfile=script-hover-pick-in-use.min.js

npx esbuild script-search-in-use-list.js --bundle --minify --outfile=script-search-in-use-list.min.js

npx esbuild script-search-in-use-list-async.js --bundle --minify --outfile=script-search-in-use-list-async.min.js
```
