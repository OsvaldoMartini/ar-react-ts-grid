  ...
  body: JSON.stringify({
    ...
    items: [{
      ...
      payload: sourceKind === 'COMPONENT'
        ...
        : { instructionId: 21, sourceRevision: 'revision-1' },
    }],
      ...
      items: [
        {
          ...
          payload: { instructionId: 21, sourceRevision: 'revision-1' },
        },
        {
          key: 'BOT_JOB:get',
          sourceKind: 'BOT_JOB',
          ...
          label: 'Get',
          dependencyGroupKey: 'family-1',
          payload: { instructionId: 22, sourceRevision: 'revision-1' },
        },
        {
          key: 'BOT_JOB:other',
          sourceKind: 'BOT_JOB',
          sourceItemKey: 'other',
          label: 'Other',
          payload: { instructionId: 23, sourceRevision: 'revision-1' },
        },
      ],
      blocks: [{ blockId: 7, blockOrderNumber: 1, blockName: 'Target' }],
      targetBlockId: 7,
