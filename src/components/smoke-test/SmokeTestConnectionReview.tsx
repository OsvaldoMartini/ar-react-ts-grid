...
import { variablesSmokeTestBlockKey } from '../variables/domain/variablesSmokeTestSimulation';
...
export interface SmokeTestConnectionReviewProps {
...
const SmokeTestConnectionReview: React.FC<
  SmokeTestConnectionReviewProps
> = ({
  review,
  scopeLabel,
  ...
  return (
    ...
    >
      <section
        ...
        aria-label={embedded ? 'Complete connection and instruction review' : undefined}
        aria-labelledby={embedded ? undefined : titleId}
        aria-describedby={embedded ? undefined : descriptionId}
...
export default SmokeTestConnectionReview;
