...
import styles from './ReconnectWebElement.module.scss';

export interface ReconnectWebElementOption {
...
export interface ReconnectWebElementProps {
   ...
   */
  compatibleTargets: readonly ReconnectWebElementOption[];
  pending: boolean;
  /** Keeps the complete selector/preview visible while persistence rules are intentionally deferred. */
...
const ReconnectWebElement: React.FC<
  ReconnectWebElementProps
> = ({
  edge,
  sourceLabel,
  currentTargetLabel,
...
export default ReconnectWebElement;
