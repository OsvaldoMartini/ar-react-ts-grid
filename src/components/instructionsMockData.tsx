...
const instructionsMockData: BlockLoopInstructionLoadDTO[] = [
  { botJobId: 1, id: 1, instructionOrderNumber: 1, name: "Popolari", description: "Label Popolari", blockId: 1, blockOrderNumber: 1, blockName: "Default Block", actions: "O:popolari", exportFile: "D:/Projects/AllinWeb/ABRWeb/Export/banca export.xlsx", refreshLoop: true },
  { botJobId: 1, id: 2, instructionOrderNumber: 2, name: "Refresh", description: "Refresh", blockId: 1, blockOrderNumber: 1, blockName: "Default Block", actions: "REFRESH" },
  { botJobId: 1, id: 24, instructionOrderNumber: 2, name: "Refresh Loop", description: "Refresh Loop", blockId: 1, blockOrderNumber: 1, blockName: "Default Block", actions: "REFRESH_LOOP", parentId: 1, operation: "30:20" },
