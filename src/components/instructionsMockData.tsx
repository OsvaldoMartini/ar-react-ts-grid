...
const instructionsMockData: BlockLoopInstructionLoadDTO[] = [
  ...
  // { botJobId: 1, id: 3, instructionOrderNumber: 3, name: "GOTO", description: "GOTO", blockId: 1, blockOrderNumber: 3, blockName: "Block Test Goto", actions: "GOTO", parentId: 39, operation: "7# Block Test 6" },

  // // Block 2                                                                                                                                                                                        
  // { botJobId: 11, id: 4, instructionOrderNumber: 3, name: "GetValue", description: "Description 2", blockId: 34, blockOrderNumber: 2, blockName: "Block Test 1", actions: "GET", parentId: 4, operation: "firstname:$FIRSTNAME" },
  // { botJobId: 11, id: 5, instructionOrderNumber: 4, name: "Check", description: "Description 3", blockId: 34, blockOrderNumber: 2, blockName: "Block Test 1", actions: "CK", parentId: 4, operation: "$firstname:=:Osvaldo" },
  // { botJobId: 11, id: 6, instructionOrderNumber: 1, name: "Instruction 5", description: "Description 5", blockId: 34, blockOrderNumber: 2, blockName: "Block Test 1", actions: "click", parentId: 4 },
  // { botJobId: 11, id: 7, instructionOrderNumber: 2, name: "SetValue", description: "Description 6", blockId: 35, blockOrderNumber: 3, blockName: "Block Test 2", actions: "SET", parentId: 4, operation: "firstName:Osvaldo" },
  // { botJobId: 11, id: 8, instructionOrderNumber: 1, name: "GetValue", description: "Description 7", blockId: 35, blockOrderNumber: 3, blockName: "Block Test 2", actions: "GET", parentId: 4, operation: "firstname:$FIRSTNAME" },
  ...
  // { botJobId: 11, id: 12, instructionOrderNumber: 4, name: "Instruction 11", description: "Description 11", blockId: 36, blockOrderNumber: 4, blockName: "Block Test 3", actions: "click", parentId: 4 },
  ...
  // { botJobId: 11, id: 17, instructionOrderNumber: 4, name: "Instruction 16", description: "Description 16", blockId: 37, blockOrderNumber: 5, blockName: "Block Test 4", actions: "click", parentId: 4 },
  ...
  // // Block 5                                                                                                                                                                                        
  // { botJobId: 11, id: 19, instructionOrderNumber: 1, name: "IF", description: "IF", blockId: 38, blockOrderNumber: 6, blockName: "Block Test 5", actions: "IF" },
  // { botJobId: 11, id: 20, instructionOrderNumber: 2, name: "GOTO", description: "GOTO", blockId: 38, blockOrderNumber: 6, blockName: "Block Test 5", actions: "GOTO", parentId: 37, operation: "2# Block Test 1" },
  // { botJobId: 11, id: 21, instructionOrderNumber: 3, name: "ENDIF", description: "ENDIF", blockId: 38, blockOrderNumber: 6, blockName: "Block Test 5", actions: "ENDIF" },
  // { botJobId: 11, id: 22, instructionOrderNumber: 4, name: "Instruction 21", description: "Description 21", blockId: 38, blockOrderNumber: 6, blockName: "Block Test 5", actions: "click", parentId: 4 },
  // { botJobId: 11, id: 23, instructionOrderNumber: 5, name: "Instruction 22", description: "Description 22", blockId: 38, blockOrderNumber: 6, blockName: "Block Test 5", actions: "click", parentId: 4 },

  // // Block 6                                                                                                                                                                                        
  // { botJobId: 11, id: 24, instructionOrderNumber: 1, name: "Instruction 23", description: "Description 23", blockId: 39, blockOrderNumber: 7, blockName: "Block Test 6", actions: "click", parentId: 4 },
