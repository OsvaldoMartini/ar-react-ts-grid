...
const instructionsMockData: BlockLoopInstructionLoadDTO[] = [
  ...
  { botJobId: 1, id: 6, instructionOrderNumber: 1, name: "IF", description: "Description 5", blockId: 3, blockOrderNumber: 3, blockName: "Block Test 3", actions: "IF", parentId: 4 },
  { botJobId: 1, id: 7, instructionOrderNumber: 2, name: "ENDIF", description: "Description 6", blockId: 3, blockOrderNumber: 3, blockName: "Block Test 4", actions: "ENDIF", parentId: 4, },
