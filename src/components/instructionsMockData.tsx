...
const instructionsMockData: BlockLoopInstructionLoadDTO[] = [
  ...
  { botJobId: 1, id: 24, instructionOrderNumber: 2, name: "Refresh Loop", description: "Refresh Loop", blockId: 1, blockOrderNumber: 1, blockName: "Default Block", actions: "REFRESH_LOOP", parentId: 1, operation: "Refresh:30:Loop:20:Parent:popolari" },
