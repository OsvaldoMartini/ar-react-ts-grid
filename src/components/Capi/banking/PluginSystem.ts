...
// PLUGIN SYSTEM
// ═══════════════════════════════════════════════════════════════
// Dynamic, modular plugin architecture for the CAPI platform.
...
export class PluginRegistry {
  private plugins: Map<string, CapiPlugin> = new Map();
  private listeners: ((plugins: CapiPlugin[]) => void)[] = [];

  /** Register a plugin */
  register(plugin: CapiPlugin): void {
  ...
  subscribe(fn: (plugins: CapiPlugin[]) => void): () => void {
  ...
  loadFromJSON(json: any): CapiPlugin | null {
    try {
