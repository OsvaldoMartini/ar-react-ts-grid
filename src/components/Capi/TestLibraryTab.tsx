...
export class TestLibraryTab extends React.Component<{}, LibraryState> {
  ...
  // ─── RENDER ─────────────────────────────────────────────────
  render() {
    const { view, search, categoryStats, totalTests, selectedCategory, selectedSubcat, filteredTests, selectedTest, pluginStates, importing } = this.state;
          ...
          <div className="lib-dashboard">
            <div className="lib-cat-grid">
              {categoryStats.map(cs => {
                ...
                return (
                  <button key={cs.category} className="lib-cat-card" onClick={() => this.openCategory(cs.category)}>
        ...
        {view === "category" && (
          <div className="lib-category-view">
            ...
            <div className="lib-test-list">
              ...
              {filteredTests.map(t => (
                <button key={t.id} className="lib-test-row" onClick={() => this.openTest(t)}>
