...
test('keeps scanner websocket command and operation ids stable', () => {
  ...
  expect(SCANNER_APP_OPERATION).toBe('SCANNER_APP');
  expect(PRE_SCAN_PAGE_OPERATION).toBe('PRE_SCAN_PAGE');
  expect(PRE_SCAN_REFRESH_PAGE_OPERATION).toBe('PRE_SCAN_REFRESH_PAGE');
  expect(PRE_SCAN_CLEAR_GRID_OPERATION).toBe('PRE_SCAN_CLEAR_GRID');
  expect(PRE_SCAN_SEND_DOM_REVIEW_OPERATION).toBe('PRE_SCAN_SEND_DOM_REVIEW');
  expect(PRE_SCAN_REQUEST_SUPPORT_OPERATION).toBe('PRE_SCAN_REQUEST_SUPPORT');
