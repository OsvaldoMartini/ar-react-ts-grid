// MultiTest/LanguagePicker.tsx
// ─────────────────────────────────────────────────────────────────────────────
// Language picker for the MultiTest shell top bar.
// Styles live in mt-shell.scss (imported by AppShell).
// ─────────────────────────────────────────────────────────────────────────────
...
function ChevronIcon({ open }: { open: boolean }) {
  return (
    <svg
      className={`mt-lt-chevron${open ? " open" : ""}`}
      width={10}
      height={10}
      viewBox="0 0 12 12"
      fill="none"
...
export function LanguagePicker() {
  ...
  // ─────────────────────────────────────────────────────────────────────────
  return (
    <div ref={ref} style={{ position: "relative" }} className="mt-lt">

      {/* Trigger */}
      <button
        className={`mt-lt-trigger${open ? " open" : ""}`}
        style={triggerStyle}
        onClick={() => setOpen(o => !o)}
        ...
        aria-expanded={open}
      >
        <span className="mt-lt-flag-ring" style={flagRingStyle}>
          <img
          ...
          <ul style={listStyle}>
            {LANGUAGES.map(lang => {
              ...
              return (
                <li
                  key={lang.code}
                  className={`mt-lt-option${isActive ? " mt-lt-opt-active" : ""}`}
                  style={optStyle}
                  role="option"
                ...
                >
                  {/* Flag */}
                  <span className="mt-lt-flag-ring" style={optFlagRing}>
                    <img
