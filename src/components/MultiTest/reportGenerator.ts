...
<title>MultiTest Report · ${s.id}</title>
<style>
:root {
  --bg:         #f1f5f9;
  --surface:    #ffffff;
...
<header class="header">
  <div class="header-top">
    <div class="header-brand">
      ...
      <div>
        <div class="header-title">MultiTest API Test Report</div>
        <div class="header-sub">API Services API Test Simulator — Automated Execution Report</div>
      </div>
    </div>
...
<!-- FOOTER -->
<footer class="footer">
  Generated by <strong>MultiTest.ai API Test Platform</strong> · Execution ID: ${s.id} · ${new Date(s.finishedAt).toLocaleString()}
</footer>
