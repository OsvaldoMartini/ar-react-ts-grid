...
import { pluginRegistry, type TestPlugin } from "../PluginSystem";
...
// ═══════════════════════════════════════════════════════════════
const clientMgmtPlugin: TestPlugin = {
  metadata: {
    ...
    author: "MultiTest Built-in", category: "client-management",
...
// ═══════════════════════════════════════════════════════════════
const accountPlugin: TestPlugin = {
  metadata: {
    ...
    author: "MultiTest Built-in", category: "account-lifecycle",
...
// ═══════════════════════════════════════════════════════════════
const paymentsPlugin: TestPlugin = {
  metadata: {
    ...
    author: "MultiTest Built-in", category: "payments-transfers",
...
// ═══════════════════════════════════════════════════════════════
const investmentPlugin: TestPlugin = {
  metadata: {
    ...
    author: "MultiTest Built-in", category: "investment-portfolio",
...
// ═══════════════════════════════════════════════════════════════
const tradingPlugin: TestPlugin = {
  metadata: {
    ...
    author: "MultiTest Built-in", category: "trading-operations",
...
// ═══════════════════════════════════════════════════════════════
const compliancePlugin: TestPlugin = {
  metadata: {
    ...
    author: "MultiTest Built-in", category: "compliance-kyc",
...
// ═══════════════════════════════════════════════════════════════
const corporatePlugin: TestPlugin = {
  metadata: {
    ...
    author: "MultiTest Built-in", category: "corporate-actions",
...
// ═══════════════════════════════════════════════════════════════
const lendingPlugin: TestPlugin = {
  metadata: {
    ...
    author: "MultiTest Built-in", category: "lending-credit",
...
// ═══════════════════════════════════════════════════════════════
const reportingPlugin: TestPlugin = {
  metadata: {
    ...
    author: "MultiTest Built-in", category: "reporting-monitoring",
...
// ═══════════════════════════════════════════════════════════════
const operationsPlugin: TestPlugin = {
  metadata: {
    ...
    author: "MultiTest Built-in", category: "operational-maintenance",
