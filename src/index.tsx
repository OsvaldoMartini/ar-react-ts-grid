...
const App: React.FC = () => {
  ...
  const [socketPort, setSocketPort] = useState<number>(54882);
  const [botJobId, setBotJobId] = useState<number>(73);
  const [botJobName, setBotJobName] = useState<string>("Test");
  const [homeBanking, setHomeBanking] = useState<number>(34);
  const [homeBankName, setHomeBankName] = useState<string>("he there");
